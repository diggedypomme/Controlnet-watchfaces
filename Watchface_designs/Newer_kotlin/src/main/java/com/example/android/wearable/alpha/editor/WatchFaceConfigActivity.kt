...
class WatchFaceConfigActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //binding.robhandsEnabledSwitch.isEnabled = false
    ...
    private fun updateWatchFaceEditorPreview(
        ...
        //binding.robhandsEnabledSwitch.isChecked = userStylesAndPreview.ticksEnabled
    ...
    private fun enabledWidgets() {
        ...
        //binding.robhandsEnabledSwitch.isEnabled = true
    ...
    fun onClickRobHandsEnabledSwitch(view: View) {
        Log.d(TAG, "onClickRobHandsEnabledSwitch() $view")
        //stateHolder.setrobDrawHands(binding.robhandsEnabledSwitch.isChecked)
    }
